#if !defined(__application_config_h)
...
#pragma warning (disable:4530)
    ...
    #ifdef __USE_DLL_KKSAPP
	    #define __KKSAPP_EXPORT __declspec(dllexport)
    #else
	    #define __KKSAPP_EXPORT __declspec(dllimport)
    #endif

#else
	#define __KKSAPP_EXPORT
#endif
