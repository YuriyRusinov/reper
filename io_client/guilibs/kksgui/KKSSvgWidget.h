...
{
public:
    KKSSvgWidget (const KKSAttrValue*attr, KKSIndAttrClass isSys, QWidget *parent=NULL, Qt::WindowFlags flags=0);
    KKSSvgWidget (const KKSAttrValue*attr, KKSIndAttrClass isSys, const QByteArray& contents, QWidget *parent=NULL, Qt::WindowFlags flags=0);
    ~KKSSvgWidget (void);
