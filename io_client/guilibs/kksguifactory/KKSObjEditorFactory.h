...
*/
class _GF_EXPORT KKSObjEditorFactory : public KKSEntityFactory
{
public:
...
private slots:
    ...
    void refreshSearchTemplates (QAbstractItemModel * searchMod);
    
    void applySearchTemplate (int idSearchTemplate);
