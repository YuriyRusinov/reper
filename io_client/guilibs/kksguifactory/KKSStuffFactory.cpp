...
void KKSStuffFactory :: setUserToPosition (const QModelIndex& posIndex, QAbstractItemModel * stuffModel)
{
    ...
    QWidget * parentWidget = qobject_cast<QWidget *>(this->sender());
    KKSRecDialog * usersEditor = oef->createObjRecEditor(IO_IO_ID, IO_USERS_ID, filters, tr ("Set user onto position"), wCat, true, false, Qt::WindowModal, parentWidget, Qt::Dialog);
