#if !defined(__kksdatafactory_config_h)
#define __kksdatafactory_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSDATAFACTORY

	#define _F_DATA_EXPORT __declspec(dllexport)
#else
	#define _F_DATA_EXPORT __declspec(dllimport)
#endif
#else
	#define _F_DATA_EXPORT
#endif
