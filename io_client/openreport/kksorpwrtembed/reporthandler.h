...
class ReportHandler : public QObject {
    ...
    public:
        ...
        QAction * populateMenuBar(QMenu * menubar, QAction * exitAction = 0);
        ...
        QToolBar * getTbFiles() const {return tbFiles;}
        QToolBar * getTbDatabase() const {return tbDatabase;}
        QToolBar * getTbEdit() const {return tbEdit;}
        QToolBar * getTbOptions() const {return tbOptions;}
        QToolBar * getTbItems() const {return tbItems;}
        QToolBar * getTbFont() const {return tbFont;}
    ...
    public slots:
        ...
        void print(qint64 idReport, bool showPreview);
        void filePrintToPDF();
        ...
        void dbLoadDoc();
        void dbLoadDoc(qint64);
        void dbSaveDoc();

        void sReportsChanged(int, bool);
		void onWinChanged(QWidget* w);
        void onSubWinChanged(QMdiSubWindow* w);
    ...
    protected:
        ...
        int getGradeById(qint64 idReport);
        QString getNameById(qint64 idReport);
        QString getSource(qint64 idReport);
