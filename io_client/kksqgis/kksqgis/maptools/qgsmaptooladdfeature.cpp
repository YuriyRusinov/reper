...
QgsMapToolAddFeature::QgsMapToolAddFeature( KKSGISWidgetBase * w, QgsMapCanvas* canvas ): QgsMapToolCapture( w, canvas )
{
}
...
{
  QgsFeatureAction action( mWorkingWidget, tr( "add feature" ), *f, vlayer, -1, -1, this );
