 ...
 *                                                                         *
 ***************************************************************************/
#ifndef QGSMAPTOOL_ADD_FEATURE_H
#define QGSMAPTOOL_ADD_FEATURE_H
...
class _QGIS_EXPORT QgsMapToolAddFeature : public QgsMapToolCapture
{
    Q_OBJECT
  public:
    QgsMapToolAddFeature( KKSGISWidgetBase * w, QgsMapCanvas* canvas );
