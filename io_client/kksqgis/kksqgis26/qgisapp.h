 ...
 */
class _QGIS_EXPORT QgisApp : public QWidget
{
    Q_OBJECT
  public:
    //! Constructor
...
//********************actions from ui_qgisapp.h

    void setAllPointersToNull();
    void internalSetupUi(QWidget * );
    void internalRetranslateUi(QWidget *);
