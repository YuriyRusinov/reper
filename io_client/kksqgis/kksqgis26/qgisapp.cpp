...
//ksa #include "qgisappstylesheet.h"
#include "qgis.h"
#include "qgisplugin.h"
//ksa #include "qgsabout.h"
#include "qgsapplayertreeviewmenuprovider.h"
#include "qgsapplication.h"
#include "qgsattributeaction.h"
#include "qgsattributetabledialog.h"
//ksa #include "qgsbookmarks.h"
//ksa #include "qgsbrowserdockwidget.h"
#include "qgsclipboard.h"
//ksa #include "qgscomposer.h"
//ksa #include "qgscomposermanager.h"
//ksa #include "qgscomposerview.h"
//ksa #include "qgsconfigureshortcutsdialog.h"
#include "qgscoordinatetransform.h"
#include "qgscredentialdialog.h"
#include "qgscursors.h"
//ksa #include "qgscustomization.h"
#include "qgscustomlayerorderwidget.h"
//ksa #include "qgscustomprojectiondialog.h"
#include "qgsdatasourceuri.h"
#include "qgsdatumtransformdialog.h"
//ksa #include "qgsdxfexport.h"
//ksa #include "qgsdxfexportdialog.h"
//ksa #include "qgsdecorationcopyright.h"
//ksa #include "qgsdecorationnortharrow.h"
//ksa #include "qgsdecorationscalebar.h"
//ksa #include "qgsdecorationgrid.h"
...
//ksa #include "qgsgpsinformationwidget.h"
...
#include "qgsmaptip.h"
//ksa #include "qgsmergeattributesdialog.h"
...
//ksa #include "qgsrastercalcdialog.h"
...
//ksa #include "qgsshortcutsmanager.h"
#include "qgssinglebandgrayrenderer.h"
#include "qgssnappingdialog.h"
//ksa #include "qgssponsors.h"
#include "qgssvgannotationitem.h"
#include "qgstextannotationitem.h"
//ksa #include "qgstipgui.h"
//ksa #include "qgsundowidget.h"
#include "qgsvectordataprovider.h"
#include "qgsvectorfilewriter.h"
#include "qgsvectorlayer.h"
#include "qgsvectorlayerproperties.h"
//ksa #include "qgsvisibilitypresets.h"
...
//ksa #include "qgsosmdownloaddialog.h"
//ksa #include "qgsosmimportdialog.h"
//ksa #include "qgsosmexportdialog.h"
...
//ksa #include "qgsmaptooladdpart.h"
//ksa #include "qgsmaptooladdring.h"
//ksa #include "qgsmaptoolfillring.h"
//ksa #include "qgsmaptoolannotation.h"
//ksa #include "qgsmaptooldeletering.h"
//ksa #include "qgsmaptooldeletepart.h"
//ksa #include "qgsmaptoolfeatureaction.h"
//ksa #include "qgsmaptoolformannotation.h"
//ksa #include "qgsmaptoolhtmlannotation.h"
#include "qgsmaptoolidentifyaction.h"
#include "qgsmaptoolmeasureangle.h"
#include "qgsmaptoolmovefeature.h"
//ksa #include "qgsmaptoolrotatefeature.h"
//ksa #include "qgsmaptooloffsetcurve.h"
...
//ksa #include "qgsmaptoolsvgannotation.h"
//ksa #include "qgsmaptoolreshape.h"
//ksa #include "qgsmaptoolrotatepointsymbols.h"
//ksa #include "qgsmaptoolsplitfeatures.h"
//ksa #include "qgsmaptoolsplitparts.h"
//ksa #include "qgsmaptooltextannotation.h"
#include "qgsmaptoolvertexedit.h"
#include "qgsmaptoolzoom.h"
//ksa #include "qgsmaptoolsimplify.h"
#include "qgsmeasuretool.h"
//ksa #include "qgsmaptoolpinlabels.h"
//ksa #include "qgsmaptoolshowhidelabels.h"
//ksa #include "qgsmaptoolmovelabel.h"
//ksa #include "qgsmaptoolrotatelabel.h"
//ksa #include "qgsmaptoolchangelabelproperties.h"
...
//ksa #include "qgsnewspatialitelayerdialog.h"

//ksa #include "qgspythonutils.h"
...
void QgisApp::initQGIS()
{

  namSetup();

  //ksa
  internalSetupUi( this );
  ...
  */
  ...
  //ksa QWidget *centralWidget = this->centralWidget();
  ...
  */
  ...
  //эта штука выводит в левой части красивые кнопки доступа к ряду провайдеров данных
  //в ddocclient они не нужны
  //ksa !!! QgsProviderRegistry::instance()->registerGuis( this );
    ...
    , mpGpsWidget( 0 )
{
  ...
  mMapCanvas->freeze();
  mLayerTreeView = new QgsLayerTreeView( this );
  //ksa mUndoWidget = new QgsUndoWidget( NULL, mMapCanvas );
  //ksa mInfoBar = new QgsMessageBar( centralWidget() );
...
QgisApp::~QgisApp()
{
  ...
  //ksa delete mMapTools.mAddPart;
  //ksa delete mMapTools.mAddRing;
  //ksa delete mMapTools.mFillRing;
  //ksa delete mMapTools.mAnnotation;
  //ksa delete mMapTools.mChangeLabelProperties;
  //ksa delete mMapTools.mDeletePart;
  //ksa delete mMapTools.mDeleteRing;
  //ksa delete mMapTools.mFeatureAction;
  //ksa delete mMapTools.mFormAnnotation;
  //ksa delete mMapTools.mHtmlAnnotation;
  delete mMapTools.mIdentify;
  delete mMapTools.mMeasureAngle;
  delete mMapTools.mMeasureArea;
  delete mMapTools.mMeasureDist;
  delete mMapTools.mMoveFeature;
  //ksa delete mMapTools.mMoveLabel;
  delete mMapTools.mNodeTool;
  //ksa delete mMapTools.mOffsetCurve;
  //ksa delete mMapTools.mPinLabels;
  //ksa delete mMapTools.mReshapeFeatures;
  //ksa delete mMapTools.mRotateFeature;
  //ksa delete mMapTools.mRotateLabel;
  //ksa delete mMapTools.mRotatePointSymbolsTool;
  ...
  //ksa delete mMapTools.mShowHideLabels;
  //ksa delete mMapTools.mSimplifyFeature;
  //ksa delete mMapTools.mSplitFeatures;
  //ksa delete mMapTools.mSplitParts;
  //ksa delete mMapTools.mSvgAnnotation;
  //ksa delete mMapTools.mTextAnnotation;

  //ksa delete mpMaptip;

  //ksa delete mpGpsWidget;

  delete mOverviewMapCursor;

  //ksa delete mComposerManager;
...
void QgisApp::createActions()
{
  ...
  //ksa connect( mActionUndo, SIGNAL( triggered() ), mUndoWidget, SLOT( undo() ) );
  //ksa connect( mActionRedo, SIGNAL( triggered() ), mUndoWidget, SLOT( redo() ) );
...
void QgisApp::createToolBars()
{
  ...
  //ksa setIconSize( QSize( size, size ) );
...
void QgisApp::setupConnections()
{
  ...
  //ksa connect( mUndoWidget, SIGNAL( undoStackChanged() ), this, SLOT( updateUndoActions() ) );
}
...
void QgisApp::createCanvasTools()
{
  ...
  //ksa mMapTools.mFeatureAction = new QgsMapToolFeatureAction( mMapCanvas );
  //ksa mMapTools.mFeatureAction->setAction( mActionFeatureAction );
  ...
  //ksa mMapTools.mTextAnnotation = new QgsMapToolTextAnnotation( mMapCanvas );
  //ksa mMapTools.mTextAnnotation->setAction( mActionTextAnnotation );
  //ksa mMapTools.mFormAnnotation = new QgsMapToolFormAnnotation( mMapCanvas );
  //ksa mMapTools.mFormAnnotation->setAction( mActionFormAnnotation );
  //ksa mMapTools.mHtmlAnnotation = new QgsMapToolHtmlAnnotation( mMapCanvas );
  //ksa mMapTools.mHtmlAnnotation->setAction( mActionHtmlAnnotation );
  //ksa mMapTools.mSvgAnnotation = new QgsMapToolSvgAnnotation( mMapCanvas );
  //ksa mMapTools.mSvgAnnotation->setAction( mActionSvgAnnotation );
  //ksa mMapTools.mAnnotation = new QgsMapToolAnnotation( mMapCanvas );
  //ksa mMapTools.mAnnotation->setAction( mActionAnnotation );
  mMapTools.mAddFeature = new QgsMapToolAddFeature( mMapCanvas );
  mMapTools.mAddFeature->setAction( mActionAddFeature );
  mMapTools.mMoveFeature = new QgsMapToolMoveFeature( mMapCanvas );
  mMapTools.mMoveFeature->setAction( mActionMoveFeature );
  //ksa mMapTools.mRotateFeature = new QgsMapToolRotateFeature( mMapCanvas );
  //ksa mMapTools.mRotateFeature->setAction( mActionRotateFeature );
//need at least geos 3.3 for OffsetCurve tool
#if defined(GEOS_VERSION_MAJOR) && defined(GEOS_VERSION_MINOR) && \
((GEOS_VERSION_MAJOR>3) || ((GEOS_VERSION_MAJOR==3) && (GEOS_VERSION_MINOR>=3)))
  //ksa mMapTools.mOffsetCurve = new QgsMapToolOffsetCurve( mMapCanvas );
  //ksa mMapTools.mOffsetCurve->setAction( mActionOffsetCurve );
#else
...
#endif //GEOS_VERSION
  //ksa mMapTools.mReshapeFeatures = new QgsMapToolReshape( mMapCanvas );
  //ksa mMapTools.mReshapeFeatures->setAction( mActionReshapeFeatures );
  //ksa mMapTools.mSplitFeatures = new QgsMapToolSplitFeatures( mMapCanvas );
  //ksa mMapTools.mSplitFeatures->setAction( mActionSplitFeatures );
  //ksa mMapTools.mSplitParts = new QgsMapToolSplitParts( mMapCanvas );
  //ksa mMapTools.mSplitParts->setAction( mActionSplitParts );
  ...
  //ksa mMapTools.mAddRing = new QgsMapToolAddRing( mMapCanvas );
  //ksa mMapTools.mAddRing->setAction( mActionAddRing );
  //ksa mMapTools.mFillRing = new QgsMapToolFillRing( mMapCanvas );
  //ksa mMapTools.mFillRing->setAction( mActionFillRing );
  //ksa mMapTools.mAddPart = new QgsMapToolAddPart( mMapCanvas );
  //ksa mMapTools.mAddPart->setAction( mActionAddPart );
  //ksa mMapTools.mSimplifyFeature = new QgsMapToolSimplify( mMapCanvas );
  //ksa mMapTools.mSimplifyFeature->setAction( mActionSimplifyFeature );
  //ksa mMapTools.mDeleteRing = new QgsMapToolDeleteRing( mMapCanvas );
  //ksa mMapTools.mDeleteRing->setAction( mActionDeleteRing );
  //ksa mMapTools.mDeletePart = new QgsMapToolDeletePart( mMapCanvas );
  //ksa mMapTools.mDeletePart->setAction( mActionDeletePart );
  mMapTools.mNodeTool = new QgsMapToolNodeTool( mMapCanvas );
  mMapTools.mNodeTool->setAction( mActionNodeTool );
  //ksa mMapTools.mRotatePointSymbolsTool = new QgsMapToolRotatePointSymbols( mMapCanvas );
  //ksa mMapTools.mRotatePointSymbolsTool->setAction( mActionRotatePointSymbols );
  //ksa mMapTools.mPinLabels = new QgsMapToolPinLabels( mMapCanvas );
  //ksa mMapTools.mPinLabels->setAction( mActionPinLabels );
  //ksa mMapTools.mShowHideLabels = new QgsMapToolShowHideLabels( mMapCanvas );
  //ksa mMapTools.mShowHideLabels->setAction( mActionShowHideLabels );
  //ksa mMapTools.mMoveLabel = new QgsMapToolMoveLabel( mMapCanvas );
  //ksa mMapTools.mMoveLabel->setAction( mActionMoveLabel );

  //ksa mMapTools.mRotateLabel = new QgsMapToolRotateLabel( mMapCanvas );
  //ksa mMapTools.mRotateLabel->setAction( mActionRotateLabel );
  //ksa mMapTools.mChangeLabelProperties = new QgsMapToolChangeLabelProperties( mMapCanvas );
  //ksa mMapTools.mChangeLabelProperties->setAction( mActionChangeLabelProperties );
...
void QgisApp::initLayerTreeView()
{
  ...
  //ksa btnVisibilityPresets->setMenu( QgsVisibilityPresets::instance()->menu() );
...
void QgisApp::saveWindowState()
{
  ...
  //ksa settings.setValue( "/UI/state", saveState() );
...
void QgisApp::fileNew( bool thePromptToSaveFlag, bool forceBlank )
{
  ...
  //ksa QgsVisibilityPresets::instance()->clear();
...
{
  //ksa qobject_cast<QgsMapToolPinLabels*>( mMapTools.mPinLabels )->showPinnedLabels( show );
}
...
{
  //ksa mMapCanvas->setMapTool( mMapTools.mShowHideLabels );
}

void QgisApp::moveLabel()
{
  //ksa mMapCanvas->setMapTool( mMapTools.mMoveLabel );
}

void QgisApp::rotateFeature()
{
  //ksa mMapCanvas->setMapTool( mMapTools.mRotateFeature );
}

void QgisApp::rotateLabel()
{
  //ksa mMapCanvas->setMapTool( mMapTools.mRotateLabel );
}

void QgisApp::changeLabelProperties()
{
  //ksa mMapCanvas->setMapTool( mMapTools.mChangeLabelProperties );
}
...
{
  //ksa mMapCanvas->setMapTool( mMapTools.mRotatePointSymbolsTool );
}
...
{
  //ksa mMapCanvas->setMapTool( mMapTools.mSplitFeatures );
}

void QgisApp::splitParts()
{
  //ksa mMapCanvas->setMapTool( mMapTools.mSplitParts );
}

void QgisApp::reshapeFeatures()
{
  //ksa mMapCanvas->setMapTool( mMapTools.mReshapeFeatures );
}
...
void QgisApp::activateDeactivateLayerRelatedActions( QgsMapLayer* layer )
{
  ...
  */
  ...
  else if ( layer->type() == QgsMapLayer::RasterLayer )
  {
    ...
    mActionToggleEditing->setChecked( false );
    mActionSaveLayerEdits->setEnabled( false );
    //ksa mUndoWidget->dockContents()->setEnabled( false );
    mActionUndo->setEnabled( false );
    mActionRedo->setEnabled( false );
    mActionSaveLayerDefinition->setEnabled( true );
    mActionLayerSaveAs->setEnabled( true );
...
{
  //ksa QgsBookmarks::newBookmark();
}

void QgisApp::showBookmarks()
{
  //ksa QgsBookmarks::showBookmarks();
}
...
//ksa
/*
  QMenu* menu = QWidget::createPopupMenu();
...
//ksa
void QgisApp::setAllPointersToNull()
{
    mActionNewProject = NULL;
    mActionOpenProject = NULL;
    mActionSaveProject = NULL;
    mActionSaveProjectAs = NULL;
    mActionSaveMapAsImage = NULL;
    mActionNewPrintComposer = NULL;
    mActionShowComposerManager = NULL;
    mActionExit = NULL;
    mActionUndo = NULL;
    mActionRedo = NULL;
    ...
    mActionReshapeFeatures = NULL;
    mActionSplitFeatures = NULL;
    mActionSplitParts = NULL;
    mActionDeleteSelected = NULL;
    mActionAddRing = NULL;
    mActionAddPart = NULL;
    mActionSimplifyFeature = NULL;
    mActionDeleteRing = NULL;
    mActionDeletePart = NULL;
    mActionMergeFeatures = NULL;
    mActionMergeFeatureAttributes = NULL;
    mActionNodeTool = NULL;
    mActionRotatePointSymbols = NULL;
    mActionSnappingOptions = NULL;
    mActionPan = NULL;
    mActionZoomIn = NULL;
    mActionZoomOut = NULL;
    mActionSelectFeatures = NULL;
    ...
    mActionMapTips = NULL;
    mActionNewBookmark = NULL;
    mActionShowBookmarks = NULL;
    mActionDraw = NULL;
    mActionTextAnnotation = NULL;
    mActionFormAnnotation = NULL;
    mActionAnnotation = NULL;
    mActionLabeling = NULL;
    mActionNewVectorLayer = NULL;
    mActionNewSpatiaLiteLayer = NULL;
    mActionShowRasterCalculator = NULL;
    mActionAddOgrLayer = NULL;
    mActionAddRasterLayer = NULL;
    mActionAddPgLayer = NULL;
    mActionAddSpatiaLiteLayer = NULL;
    mActionAddMssqlLayer = NULL;
    mActionAddOracleLayer = NULL;
    mActionAddWmsLayer = NULL;
    mActionOpenTable = NULL;
    mActionToggleEditing = NULL;
    mActionSaveEdits = NULL;
    mActionLayerSaveAs = NULL;
    ...
    mActionAddToOverview = NULL;
    mActionAddAllToOverview = NULL;
    mActionRemoveAllFromOverview = NULL;
    mActionShowAllLayers = NULL;
    mActionHideAllLayers = NULL;
    mActionManagePlugins = NULL;
    mActionToggleFullScreen = NULL;
    mActionProjectProperties = NULL;
    mActionOptions = NULL;
    mActionCustomProjection = NULL;
    mActionConfigureShortcuts = NULL;
    mActionLocalHistogramStretch = NULL;
    mActionHelpContents = NULL;
    mActionHelpAPI = NULL;
    mActionQgisHomePage = NULL;
    mActionCheckQgisVersion = NULL;
    mActionAbout = NULL;
    mActionSponsors = NULL;
    mActionMoveLabel = NULL;
    mActionRotateLabel = NULL;
    mActionChangeLabelProperties = NULL;
    mActionStyleManagerV2 = NULL;
    mActionShowPythonDialog = NULL;
    mActionFullHistogramStretch = NULL;
    mActionAddLayerSeparator = NULL;
    mActionCustomization = NULL;
    actionActionCatchForCustomization = NULL;
    mActionEmbedLayers = NULL;
    mActionDecorationCopyright = NULL;
    mActionDecorationNorthArrow = NULL;
    mActionDecorationScaleBar = NULL;
    mActionAddWfsLayer = NULL;
    mActionFeatureAction = NULL;
    mActionPanToSelected = NULL;
    mActionTouch = NULL;
    mActionOffsetCurve = NULL;
    mActionCopyStyle = NULL;
    mActionPasteStyle = NULL;
    mActionAddWcsLayer = NULL;
    mActionDecorationGrid = NULL;
    mActionPinLabels = NULL;
    mActionShowPinnedLabels = NULL;
    mActionNewBlankProject = NULL;
    mActionLocalCumulativeCutStretch = NULL;
    mActionFullCumulativeCutStretch = NULL;
    mActionShowHideLabels = NULL;
    mActionHtmlAnnotation = NULL;
    mActionDuplicateLayer = NULL;
    mActionSvgAnnotation = NULL;
    ...
    mActionRotateFeature = NULL;
    mActionOSMDownload = NULL;
    mActionOSMImport = NULL;
    mActionOSMExport = NULL;
    mActionIncreaseBrightness = NULL;
    mActionDecreaseBrightness = NULL;
    mActionIncreaseContrast = NULL;
    mActionDecreaseContrast = NULL;
    mActionSelectByExpression = NULL;
    mActionNeedSupport = NULL;
    mActionOpenFieldCalc = NULL;
    mActionAddDelimitedText = NULL;
    mActionPasteAsNewVector = NULL;
    mActionPasteAsNewMemoryVector = NULL;
    mActionDxfExport = NULL;
    mActionFillRing = NULL;
    mActionAddLayerDefinition = NULL;
    mActionSaveLayerDefinition = NULL;
    mActionPreviewModeOff = NULL;
    mActionPreviewModeGrayscale = NULL;
    mActionPreviewModeMono = NULL;
    mActionPreviewProtanope = NULL;
    mActionPreviewDeuteranope = NULL;
    mActionSetLayerScaleVisibility = NULL;
    mActionShowSelectedLayers = NULL;
    mActionHideSelectedLayers = NULL;

    menubar = NULL;
    mProjectMenu = NULL;
    mRecentProjectsMenu = NULL;
    mPrintComposersMenu = NULL;
    mProjectFromTemplateMenu = NULL;
    mViewMenu = NULL;
    menuSelect = NULL;
    menuMeasure = NULL;
    menuDecorations = NULL;
    mMenuPreviewMode = NULL;
    mLayerMenu = NULL;
    mNewLayerMenu = NULL;
    mAddLayerMenu = NULL;
    mPluginMenu = NULL;
    ...
    mFileToolBar = NULL;
    mLayerToolBar = NULL;
    mDigitizeToolBar = NULL;
    mAdvancedDigitizeToolBar = NULL;
    mMapNavToolBar = NULL;
    mAttributesToolBar = NULL;
    mPluginToolBar = NULL;
    mHelpToolBar = NULL;
    mRasterToolBar = NULL;
    mLabelToolBar = NULL;
    mVectorToolBar = NULL;
    mDatabaseToolBar = NULL;
    mWebToolBar = NULL;

    mBtnFilterLegend = NULL;
    mVectorLayerTools = NULL;
    mMacrosWarn = NULL;
    mInfoBar = NULL;
    mLogViewer = NULL;
    mLastMapToolMessage = NULL;
    mpGpsWidget = NULL;
    mpTileScaleWidget = NULL;
    mComposerManager = NULL;
    mPluginManager = NULL;
    mSnappingDialog = NULL;
    mBrowserWidget2 = NULL;
    mBrowserWidget = NULL;
    mUndoWidget = NULL;
    mPythonUtils = NULL;
    mpMaptip = NULL;
    mDizzyTimer = NULL;
    mpMapTipsTimer = NULL;
    mInternalClipboard = NULL;
    //ksa mSplash = NULL;
    mMapWindow = NULL;
    mOverviewMapCursor = NULL;
    mMapLayerOrder = NULL;
    mLayerTreeCanvasBridge = NULL;
    mLayerTreeView = NULL;
    mMapCanvas = NULL;
    toolPopupDisplay = NULL;
    toolPopupOverviews = NULL;
    mWebMenu = NULL;
    mDatabaseMenu = NULL;
    mPopupMenu = NULL;
    mFeatureActionMenu = NULL;
    mOnTheFlyProjectionStatusButton = NULL;
    mOnTheFlyProjectionStatusLabel = NULL;
    mToggleExtentsViewButton = NULL;
    mRenderSuppressionCBox = NULL;
    mProgressBar = NULL;
    mCoordsEditValidator = NULL;
    mCoordsEdit = NULL;
    mCoordsLabel = NULL;
...
void QgisApp::internalSetupUi(QWidget *MainWindow)
{
        /*
        ...
        */
        ...
        internalRetranslateUi(MainWindow);

        QMetaObject::connectSlotsByName(MainWindow);
    } // setupUi

    void QgisApp::internalRetranslateUi(QWidget * MainWindow)
    {
        ...
        mActionExit->setText(QApplication::translate("MainWindow", "Exit QGIS", 0, QApplication::UnicodeUTF8));
