#if !defined(__kksqgis_config_h)
#define __kksqgis_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSQGIS

	#define _QGIS_EXPORT __declspec(dllexport)
#else
	#define _QGIS_EXPORT __declspec(dllimport)
#endif
#else
	#define _QGIS_EXPORT
#endif

#define APP_EXPORT _QGIS_EXPORT
