#if !defined(__kkssqv_config_h)
#define __kkssqv_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_SYNCQUEUEVIEWER

	#define _SQV_EXPORT __declspec(dllexport)
#else
	#define _SQV_EXPORT __declspec(dllimport)
#endif
#else
	#define _SQV_EXPORT
#endif
