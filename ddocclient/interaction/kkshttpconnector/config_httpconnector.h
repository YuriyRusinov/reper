#if !defined(__httpconnector_config_h)
#define __httpconnector_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSHTTPCONNECTOR

	#define __HTTP_CONNECTOR_EXPORT __declspec(dllexport)
#else
	#define __HTTP_CONNECTOR_EXPORT __declspec(dllimport)
#endif
#else
	#define __HTTP_CONNECTOR_EXPORT
#endif
