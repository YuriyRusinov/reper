...
#ifdef Q_WS_WIN
//for web
void KKSRecord::setName_w(const std::string & name)
{
    return setName(QString::fromUtf8(name.c_str()));
}

std::string KKSRecord::name_w() 
{
    std::string s;
    s = name().toUtf8();
    return s;
...
void KKSRecord::setDesc_w(const std::string & desc)
{
    return setDesc(QString::fromUtf8(desc.c_str()));
}

std::string KKSRecord::desc_w() 
{
    std::string s;
    s = desc().toUtf8();
    return s;
...
void KKSRecord::setCode_w(const std::string & code)
{
    return setCode(QString::fromUtf8(code.c_str()));
}

std::string KKSRecord::code_w() 
{
    std::string s;
    s = code().toUtf8();
    return s;
