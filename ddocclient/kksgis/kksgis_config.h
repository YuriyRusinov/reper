#if !defined(__kksgis_config_h)
#define __kksgis_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSGIS

	#define _GIS_EXPORT __declspec(dllexport)
#else
	#define _GIS_EXPORT __declspec(dllimport)
#endif
#else
	#define _GIS_EXPORT
#endif
