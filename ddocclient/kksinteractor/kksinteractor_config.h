#if !defined(__kksinteractor_config_h)
#define __kksinteractor_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSINTERACTOR
	#define _I_EXPORT __declspec(dllexport)
#else
	#define _I_EXPORT __declspec(dllimport)
#endif
#else
	#define _I_EXPORT
#endif
