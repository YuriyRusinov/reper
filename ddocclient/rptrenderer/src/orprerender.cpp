...
//  qDebug () << __PRETTY_FUNCTION__;
  ...
  QString tagSql = getSqlFromTag("fmt03", _internal->_database.driverName());
  //qDebug () << __PRETTY_FUNCTION__ << tagSql << _internal->_database.driverName();
  ...
  //qDebug () << __PRETTY_FUNCTION__ << tQuery;
/*
