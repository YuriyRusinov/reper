...
#define _MAX_FILE_BLOCK3 1000000  //1MB - размер блока файла, который должен передаваться по транспорту информационного обмена, если осуществляется передача файлов частями
