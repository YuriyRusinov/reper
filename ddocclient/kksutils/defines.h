...
#define _MAX_FILE_BLOCK2 5000000  //размер файла максимально разрешенный при передаче одним пакетом по транспорту информационного обмена. При больших размерах бьем на части
