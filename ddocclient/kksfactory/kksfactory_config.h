#if !defined(__kksfactory_config_h)
#define __kksfactory_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSFACTORY

	#define _F_EXPORT __declspec(dllexport)
#else
	#define _F_EXPORT __declspec(dllimport)
#endif
#else
	#define _F_EXPORT
#endif
