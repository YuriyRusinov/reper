#if !defined(__kkspluginmanager_config_h)
#define __kkspluginmanager_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSPLUGINMANAGER
	#define _KKSPLUGIN_EXPORT __declspec(dllexport)
#else
	#define _KKSPLUGIN_EXPORT __declspec(dllimport)
#endif
#else
	#define _KKSPLUGIN_EXPORT
#endif
