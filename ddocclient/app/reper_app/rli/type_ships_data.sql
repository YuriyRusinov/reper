...
begin;
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-1', 1, 'Авианосец', 'Авианосец', 'CV');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-2', 2, 'Крейсер УРО', 'Крейсер УРО', 'CG');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-3', 3, 'Эскадренный миноносец УРО', 'Эскадренный миноносец УРО', 'DDG');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-4', 4, 'Эскадренный миноносец', 'Эскадренный миноносец', 'DD');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-5', 5, 'Фрегат УРО', 'Фрегат УРО', 'FFG');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-6', 6, 'Фрегат', 'Фрегат', 'FFL');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-7', 7, 'Корвет', 'Корвет', 'FS');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-8', 8, 'Патрульный корабль', 'Патрульный корабль', 'PF');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-9', 9, 'Ракетный катер', 'Ракетный катер', 'PHM');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-10', 10, 'Торпедный катер', 'Торпедный катер', 'PT');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-11', 11, 'Патрульный катер', 'Патрульный катер', 'PTF');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-12', 12, 'Десантный корабль штабной', 'Десантный корабль штабной', 'LCC');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-13', 13, 'Десантный корабль универсальный', 'Десантный корабль универсальный', 'LPA');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-14', 14, 'Десантный корабль вертолетоносец', 'Десантный корабль вертолетоносец', 'LPH');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-15', 15, 'Десантный корабль танкодесантный', 'Десантный корабль танкодесантный', 'LST');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-16', 16, 'Десантный катер', 'Десантный катер', 'LCA');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-17', 17, 'Транспортное судно универсальное', 'Транспортное судно универсальное', 'AKS');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-18', 18, 'Транспортное судно снабжения', 'Транспортное судно снабжения', 'AFS');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-19', 19, 'Транспортное судно боеприпасы', 'Транспортное судно боеприпасы', 'AE');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-20', 20, 'Танкер-заправщик', 'Танкер-заправщик', 'AO');
insert into type_ship (unique_id, id, rr_name, name, code) values ('localorg_type_ship-21', 21, 'Минно-тральный корабль', 'Минно-тральный корабль', 'AM');
