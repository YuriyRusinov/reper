...
{
    public:
        KKSTimeEdit (const KKSAttrValue*attr, KKSIndAttr::KKSIndAttrClass isSys, QWidget *parent=NULL);
        KKSTimeEdit (const KKSAttrValue*attr, KKSIndAttr::KKSIndAttrClass isSys, const QTime& time, QWidget * parent=NULL);
