...
KKSCharts::KKSCharts()//QPainter *painter)

{
    ...
    ctype = KKSCharts::Dpie;
    cltype = KKSCharts::Vertical;
    cX = 0;
    cY = 0;
    cW = 100;
    cH = 100;
...
int KKSCharts::addPiece(QString name,Qt::GlobalColor color,float Percentage)
{
    this->nPiece++;
...
int KKSCharts::addPiece(QString name, QColor color, float Percentage)
{
    this->nPiece++;
    pieceNC piece;
    piece.addName(name);
...
int KKSCharts::setCords(double x, double y, double w, double h)
{
    this->cX = x;
    this->cY = y;
    this->cW = w;
...
int KKSCharts::setLegendCords(double x, double y)
{
    this->lX = x;
    this->lY = y;
...
int KKSCharts::setType(KKSCharts::type t)
{
    this->ctype = t;
...
int KKSCharts::setLegendType(KKSCharts::legend_type t)
{
    this->cltype = t;

    return 0;
}
int KKSCharts::setFont(QFont f)
{
    this->font = f;
...
int KKSCharts::setShadows(bool ok)
{
    this->shadows = ok;
...
int KKSCharts::draw(QPainter *painter)
{
    painter->setRenderHint(QPainter::Antialiasing);
    painter->setPen(Qt::NoPen);
    if (this->ctype==KKSCharts::Pie)
    {
      pW = 0;
      double pdegree = 0;
    ...
    else if (this->ctype==KKSCharts::Dpie)
    {
        pW = 50;
        double pdegree = 0;
        QPointF p;
    ...
    else if (this->ctype==KKSCharts::Histogramm)
    {
        double pDist = 15;
...
int KKSCharts::drawLegend(QPainter *painter)
{
    //double ptext = 25;
    double angle = palpha;
    painter->setPen(Qt::SolidLine);
...
QPointF KKSCharts::GetPoint(double angle, double R1, double R2)
{
    if (R1 == 0 && R2 == 0)
    {
        R1 = cW;
...
int KKSCharts::GetQuater(double angle)
{
...
double KKSCharts::Angle360(double angle)
{
    int i = (int)angle;
