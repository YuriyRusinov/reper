...
{
public:
    KKSCheckBox (const KKSAttrValue * attr, bool isSys, QWidget *parent=NULL);
    KKSCheckBox (const KKSAttrValue* attr, bool isSys, const QString& text, QWidget *parent=NULL);
