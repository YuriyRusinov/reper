...
KKSEdit :: KKSEdit (const KKSAttrValue *attr, bool isSys, QWidget *parent)
...
KKSEdit :: KKSEdit (const KKSAttrValue *attr, bool isSys, const QString& contents, QWidget *parent)
