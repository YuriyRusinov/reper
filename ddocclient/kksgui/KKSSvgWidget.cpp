...
KKSSvgWidget :: KKSSvgWidget (const KKSAttrValue *attr, bool isSys, QWidget *parent, Qt::WindowFlags flags)
...
KKSSvgWidget :: KKSSvgWidget (const KKSAttrValue *attr, bool isSys, const QByteArray& contents, QWidget *parent, Qt::WindowFlags flags)
    : QWidget (parent, flags), KKSAttrWidget(attr, isSys),
