#if !defined(__coreapplication_config_h)
#define __coreapplication_config_h
/* ==================================================================== */
...
#pragma warning (disable:4530)
	    ...
	    #define __COREAPP_EXPORT __declspec(dllexport)
    #else
	    #define __COREAPP_EXPORT __declspec(dllimport)
    #endif

#else
	#define __COREAPP_EXPORT
#endif
