...
public:
    ...
    void setExpanded(bool yes) {m_isExpanded = yes;} //используется для целей отображения в редакторе шаблонов. Хранит флаг, определяющий, является ли элемент дерева развернутым или нет
