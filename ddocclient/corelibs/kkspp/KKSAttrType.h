...
public:
   ...
   enum KKSAttrTypes
   {
       ...
       atSysChildCategoryRef = 39,//Служебный атрибут. Ссылка на категорию таблицы справочника. 
                                  //Добавляется автоматически. Работать с ним запрещено
       atSysUUID_T = 40,          //Служебный атрибут. Уникальный идентификатор записи справочника. UUID_T
       atUserDef = 41             //пользовательский (for future use)
   };
