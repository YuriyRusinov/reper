...
class _QGIS_EXPORT QgsAttributeTableDialog : public QDialog, private Ui::QgsAttributeTableDialog
{
    Q_OBJECT
  ...
  public:
     ...
     */
    QgsAttributeTableDialog( KKSGISWidgetBase * w, QgsVectorLayer *theLayer, QWidget *parent = 0, Qt::WindowFlags flags = Qt::Window );
