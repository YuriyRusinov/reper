#if !defined(__kksguifactory_config_h)
#define __kksguifactory_config_h
/* ==================================================================== */
...
#ifdef __USE_DLL_KKSGUIFACTORY

	#define _GF_EXPORT __declspec(dllexport)
#else
	#define _GF_EXPORT __declspec(dllimport)
#endif
#else
	#define _GF_EXPORT
#endif
