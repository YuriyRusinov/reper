...
<tr>
    <th colspan="2">Загрузка файла</th>
</tr>
<tr>
    <td align="right" class="required" nowrap>Имя файла:</td>
    <td width="100%"><input type="text" name="name" value="<?= htmlspecialchars($name); ?>" class="wide" /></td>
</tr>
<tr>
    <td align="right" class="required">Файл:</td>
    <td width="100%"><input type="file" name="file" value="" class="wide" /></td>
</tr>
<tr>
