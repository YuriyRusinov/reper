...
<tr>
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td width="70%">
                    <select name="io_id" class="wide" disabled>
                        <option value="" />                        
                        <?
...
<tr>
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td width="70%">
                    <select name="sender_id" class="wide" disabled>
                        <option value="" />                        
                        <?
                            for ($i=0;$i<count($empl);$i++) {
                                ?>
                                    <option value="<?= $empl[$i]->id; ?>"<?=($message_journal->id_dl_sender==$empl[$i]->id ? ' selected="selected"':'');?> ><?= htmlspecialchars($empl[$i]->name); ?></option>
                                <?
                            }
                        ?>
                    </select>
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td width="70%">
                    <select name="receiver_id" class="wide" disabled>
                        <option value="" />                        
                        <?
                            for ($i=0;$i<count($empl);$i++) {
                                ?>
    ...
    <td valign="top" >
		...
		<td align="right">Текст сообщения:</td>
              <td>  <textarea name="description" class="wide" rows="4" disabled><?= htmlspecialchars($message_journal->message_body); ?></textarea>
            </td>
		</tr>
