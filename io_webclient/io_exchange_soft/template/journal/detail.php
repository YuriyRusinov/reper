...
<tr>
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
         ...
         <tr>
    <td align="right" valign="top">ИКА:</td>
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td width="70%">
                    <select name="ika_id" class="wide" disabled>
                        <option value="" />                        
                        <?
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td width="70%">
                    <select name="exec_id" class="wide" disabled>
                        <option value="" />                        
                        <?
                            for ($i=0;$i<count($empl);$i++) {
                                ?>
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td width="70%">
                    <select name="jr_state" class="wide" disabled >
                        <option value="" />                        
                        <?
    ...
    <td valign="top" >
        ...
        <tr>
            ...
            <td>
                <input id="year-field" type="text" name="date" value="<?= htmlspecialchars($date); ?>"  class="date" disabled/>
                <button onclick="return false;" class="minibutton"><img src="<?= SITE_URI_ROOT; ?>img/iconCalendar.gif" height="16" width="16" border="0" id="calbtn3"/></button>
            </td>
        </tr>  
        <tr>
    	...
    	<td><input type="text" name="start_time" value="<?= htmlspecialchars($start_time); ?>" class="date" disabled/></td>
		</tr>
		 <tr>
            <td align="right" width="100">Исполнить к (дата дд.мм.гггг):</td>
            <td>
                <input id="year-field2" type="text" name="date2" value="<?= htmlspecialchars($date); ?>"  class="date" disabled/>
                <button onclick="return false;" class="minibutton"><img src="<?= SITE_URI_ROOT; ?>img/iconCalendar.gif" height="16" width="16" border="0" id="calbtn3"/></button>
            </td>
        </tr> 
    	...
    	<td><input type="text" name="stop_time" value="<?= htmlspecialchars($stop_time); ?>" class="date" disabled/></td>
		</tr>
		<tr>
		<td align="right">Текст распоряжения:</td>
              <td>  <textarea name="description" class="wide" rows="4" disabled><?= htmlspecialchars($journal->message_body); ?></textarea>
            </td>
		</tr>
...
?>
    ...
    <td width="100%" class="tableIn">
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
            <td align="right" valign="top">Принять к исполнению:</td>
                <td width="30%">
                    <select name="jr_work" class="wide">
...
?>
    ...
    <td colspan="3" class="toolbar">
        ...
        <button type="submit" class="button" >ОК &raquo;</button>  
