...
<input type="hidden" name="code" value="<?= htmlspecialchars($io_object->code); ?>" />
...
<tr>
                    ...
                    <select name="state_id" class="wide" <?= $id===0 ? 'disabled':''?> >
                        ...
                        <?
                            for ($i=0;$i<count($states);$i++) {
                                ?>
                                    <option value="<?= $states[$i]->id; ?>"<?=(($io_object->id_io_state==$states[$i]->id || ($id==0)) ? ' selected="selected"':'');?> ><?= htmlspecialchars($states[$i]->name); ?></option>
                                <?
                            }
                        ?>
                    </select>
	...
	<tr>
		<td align="right">Koд</td>
              <td>  <input type="text" name="cod" class="wide" rows="4" value="<?= htmlspecialchars($io_object->code); ?>" disabled/>
            </td>
		</tr>
