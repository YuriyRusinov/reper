...
function SelectDepartment(itemId) {
    ...
    //    var system = tree.getAttribute(itemId,"sys");
...
tree.setXMLAutoLoading("<?= SITE_HTTP_ROOT; ?>directory.php?module=journal&view=tree");
tree.attachEvent("onXLE", RestoreTree);
tree.loadXML("<?= SITE_HTTP_ROOT; ?>directory.php?module=journal&view=tree&id=root");
