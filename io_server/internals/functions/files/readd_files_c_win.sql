...
create or replace function initrand () returns int4
    as '$libdir/libfloader.dll', 'initrand' language 'c' strict security definer;

create or replace function droprand () returns int4
    as '$libdir/libfloader.dll', 'initrand' language 'c' strict security definer;

create or replace function unirand () returns float8
    as '$libdir/libfloader.dll', 'unirand' language 'c' strict security definer;

create or replace function gaussrand (float8) returns float8
    as '$libdir/libfloader.dll', 'gaussrand' language 'c' strict security definer;
