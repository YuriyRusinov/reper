select f_safe_drop_type('h_x_xml_parameters');

CREATE TYPE h_x_xml_parameters AS (attr_code varchar, attr_name varchar, attr_title varchar, attr_type varchar, attr_value varchar);

-- Function: getxmlparameteres()
CREATE OR REPLACE FUNCTION xGetXMLParams(character varying)
  RETURNS SETOF h_x_xml_parameters AS
$BODY$
declare
