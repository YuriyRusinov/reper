...
create  index i_attrs_values_o on attrs_values using BTREE (
id_io_object
);
...
select acl_secureTable(table_name) from tbl_io_objects where id > 200 and table_name is not null;
