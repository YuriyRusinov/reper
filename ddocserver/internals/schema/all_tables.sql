...
'Данное поле является системным и используется только базой данных для реализации механизма управления пользовательскими обработчиками применительно к справочнику информационных объектов.
