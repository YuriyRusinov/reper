...
insert into attributes (unique_id, id, id_a_type, code, name, title, table_name, column_name, def_width, is_system, id_ref_attr_type) values('localorg-attributes-228', 228, 2, 'id_shu_dls', 'Должностное лицо (Заря22)', 'Должностное лицо (Заря22)', 'shu_dls', 'name', 150, TRUE, 9);
...
insert into attributes (unique_id, id, id_a_type, code, name, title, table_name, column_name, def_width, is_system, id_ref_attr_type) values('localorg-attributes-230', 230, 2, 'id_shu_domain', 'Предметная область', 'Предметная область', 'shu_domains', 'name', 150, TRUE, 9);
...
insert into attributes (unique_id, id, id_a_type, code, name, title, table_name, column_name, def_width, is_system, id_ref_attr_type) values('localorg-attributes-266', 266, 17, 'shu_dls_position', 'Соответствующее ДЛ в системе DynamicDocs', 'Соответствующее ДЛ в системе DynamicDocs', 'position', 'name', 200, TRUE, 9);
...
begin
    ...
    SELECT pg_catalog.setval('a_groups_id_seq', idGroup+10, true);
    SELECT pg_catalog.setval('io_templates_id_seq', idTemplate+2, true);
